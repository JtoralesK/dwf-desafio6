...
var _room = require("./pages/roomid/room");
var _waiting = require("./pages/waiting/waiting");
...
},{"./state":"8yenE","./router":"km3vf","./pages/home/home":"9SRtj","./pages/instrucciones/instru":"aDbaM","./pages/play/play":"gDFwN","./pages/move/move":"ayOLG","./pages/signup/signup":"iCILb","./pages/roomid/room":"7tuqq","./pages/waiting/waiting":"j7DfX","./components/button/button":"aSwMc","./components/text/text":"1zcpL","./components/manos/tijera":"2EcJM","./components/manos/papel":"dk7tI","./components/manos/piedra":"lW0rk"}],"8yenE":[function(require,module,exports) {
...
const state = {
    ...
    init () {
        ...
        if (!localStorage.game) this.setState(cs);
        else {
    ...
    IdentificadorPlater (iam, callback) {
        const cs = this.getState();
        cs.player1.iam = iam;
        this.setState(cs);
        callback();
    },
    setPlayersOnline (connection, callback) {
        const cs = this.getState();
    ...
    signUp (callback) {
        const cs = this.getState();
        if (cs.player1.name) fetch(API_BASE_URL + "/signup", {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
            body: JSON.stringify({
                nombre: cs.player1.name
            })
        }).then((res)=>{
            return res.json();
        }).then((resp)=>{
    ...
    auth (callback) {
        const cs = this.getState();
        if (cs.player1.name) fetch(API_BASE_URL + "/auth", {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
    ...
    createRoom (callback) {
        const cs = this.getState();
        if (cs.player1.userId) fetch(API_BASE_URL + "/rooms", {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
    ...
    listenToRoom () {
        ...
        const referdata = _database.ref(_rtdb.rtdb, "/rooms/" + cs.player1.rtdbId);
        _database.onValue(referdata, (snapshot)=>{
...
},{"firebase/database":"8ymbL","./rtdb":"5w5md","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8ymbL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _database = require("@firebase/database");
...
},{}],"lLbXy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5w5md":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"lLbXy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"km3vf":[function(require,module,exports) {
...
},{"@vaadin/router":"5sGjx"}],"5sGjx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9SRtj":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class Home extends HTMLElement {
    connectedCallback() {
        this.render();
        const button1 = document.querySelector(".button_home_newGame");
        const button2 = document.querySelector(".button_home_ingresoSala");
        const button3 = document.querySelector(".button_home_ingreso");
        const input = document.querySelector(".input_codigo_room");
        const form = document.querySelector(".form");
        button1.addEventListener("click", (res)=>{
            _router.Router.go("/signup");
        });
...
},{"@vaadin/router":"5sGjx","../../state":"8yenE"}],"aDbaM":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class Instru extends HTMLElement {
    connectedCallback() {
        ...
        button.addEventListener("click", (res)=>{
            ...
            if (cs.player1.iam == "online") _router.Router.go("/wait");
            else if (cs.player1.iam == "local") {
                const date = new Date();
                const hora = date.toString();
                _state.state.setPlayersOnline(hora, ()=>{
                    _state.state.pushDataCreadorPartida();
                    _state.state.listenToRoom();
                    _router.Router.go("/wait");
                });
            }
        });
    }
...
},{"@vaadin/router":"5sGjx","../../state":"8yenE"}],"gDFwN":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
...
class Play extends HTMLElement {
    ...
    render() {
        const reloj = _tempo.cargarSegundo({
      ...
      <papel-el variante="ultimaJugada" class="i "></papel-el></div>
       ...
       `;
        ...
        const tijera = this.querySelector(".buttonTijera");
        const piedra = this.querySelector(".buttonPiedra");
        const papel = this.querySelector(".buttonPapel");
        const tijeraa = this.querySelector(".p");
        const piedraa = this.querySelector(".o");
        const papeel = this.querySelector(".i");
...
},{"../../state":"8yenE","@vaadin/router":"5sGjx","../../components/temporizador/tempo":"g12GX"}],"g12GX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./tempo.css":"lbRcL","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lbRcL":[function() {},{}],"ayOLG":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
    ...
    render() {
     ...
     <papel-el variante="elegida" class="manos buttonPapel"></papel-el>
      ...
      `;
        ...
        function elige() {
            const container = this.querySelector(".hijo");
...
},{"../../state":"8yenE","@vaadin/router":"5sGjx"}],"iCILb":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class Signup extends HTMLElement {
    connectedCallback() {
        ...
        formm.addEventListener('submit', function(e) {
            ...
            const cs = _state.state.getState();
            _state.state.setName(name);
            if (cs.roomId == "") _state.state.signUp(()=>{
                console.log(name, "se ha registrado");
                _state.state.createRoom(()=>{
                    console.log("room creado");
                    _state.state.connectRtdb(()=>{
                        _state.state.IdentificadorPlater("local", ()=>{
                            _router.Router.go("/room");
                        });
                    });
                });
            });
            else _state.state.signUp(()=>{
                console.log(name, "se ha registrado");
                _state.state.connectRtdb(()=>{
                    const date = new Date();
                    const hora = date.toString();
                    _state.state.IdentificadorPlater("online", ()=>{
                        _state.state.setPlayersOnline(hora, ()=>{
                            _state.state.pushDataOtroJugador();
                            _state.state.listenToRoom();
                        });
                        _router.Router.go("/room");
                    });
...
},{"@vaadin/router":"5sGjx","../../state":"8yenE"}],"7tuqq":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class Room extends HTMLElement {
    connectedCallback() {
        this.render();
        const cs1 = _state.state.getState();
        const room = cs1.roomId;
        const firstName = cs1.player1.name;
        const secondName1 = cs1.player2.name;
        this.player2 = secondName1;
  ...
  .ready:hover{
    ...
    `;
        ...
        button.addEventListener("click", (res)=>{
            _router.Router.go("/instrucciones");
        });
        this.appendChild(style);
    }
    constructor(...args){
...
},{"@vaadin/router":"5sGjx","../../state":"8yenE"}],"j7DfX":[function(require,module,exports) {
var _state = require("../../state");
class Wait extends HTMLElement {
    connectedCallback() {
        ...
        if (player1 == comienzoJuego && player1 == comienzoJuego) console.log("hola");
    }
    render() {
        const style = document.createElement("style");
        this.innerHTML = `
...
},{"../../state":"8yenE"}],"aSwMc":[function(require,module,exports) {
...
},{}],"1zcpL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"dk7tI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
